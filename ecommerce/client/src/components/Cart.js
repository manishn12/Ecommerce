    ...
    return (
        ...
        {carts.length == 0  ? <p style={{textAlign:"center" , color:"red", fontSize:"40px",margin:"20px"}}>Cart is empty</p > : <h1 style={{ textAlign: "center" }}> Your Cart</h1>}
            {carts.map((cart) => (
                ...
                < div className= "card mb-3 text-white" style={{width:"100%" ,height:"200px", background:"#242424" , border:"1px solid #fff"}} >
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="col-md-8 col-sm-4" >
                            ...
                            <div>
                               ...
                               <RiDeleteBin6Line className="delete-icon" style={{color:"red"}} onClick={()=>{
                                  removeCartToast()
                                 let credCart = {
                                     cart: cart ,
                                     email: credentials.email
